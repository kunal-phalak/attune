...
export const EDITOR_CHROME = {
  ...
  islandGap: 4,
  islandRadius: 10,
  islandRing: 'color-mix(in oklch, var(--color-kumo-line) 88%, transparent)',
  islandElevation: '0 8px 24px color-mix(in oklch, black 10%, transparent)',
  horizontalGap: 8,
  verticalGap: 8,
...
export const editorChromeCssVariables: CSSProperties & Record<`--editor-${string}`, string> = {
  ...
  '--editor-island-radius': `${EDITOR_CHROME.islandRadius}px`,
  '--editor-island-ring': EDITOR_CHROME.islandRing,
  '--editor-island-elevation': EDITOR_CHROME.islandElevation,
  '--editor-horizontal-gap': `${EDITOR_CHROME.horizontalGap}px`,
  '--editor-vertical-gap': `${EDITOR_CHROME.verticalGap}px`,
  ...
  '--editor-panel-header-height': `${EDITOR_CHROME.panelHeaderHeight}px`,
  '--editor-panel-content-inset': `${EDITOR_CHROME.panelContentInset}px`,
