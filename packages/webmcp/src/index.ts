...
export const PROBABILISTIC_WEBMCP_EVALS: readonly ProbabilisticWebMcpEval[] = [
  {
    ...
    preferredTools: ['inspect_attune_workspace', 'compare_valid_changes', 'apply_attune_repair'],
  ...
  },
  {
    ...
    preferredTools: ['inspect_attune_workspace', 'compare_valid_changes'],
    forbiddenTools: ['materialize_attune_revision'],
    successCriteria: [
  ...
  },
  {
    ...
    preferredTools: ['inspect_attune_workspace'],
    forbiddenTools: [],
    successCriteria: [
  ...
  },
  {
    ...
    preferredTools: ['inspect_attune_workspace', 'materialize_attune_revision'],
    forbiddenTools: [],
    successCriteria: [
  ...
  },
  {
    ...
    preferredTools: ['apply_attune_repair', 'inspect_attune_workspace'],
    forbiddenTools: [],
    successCriteria: [
