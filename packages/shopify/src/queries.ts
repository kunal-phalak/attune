...
export const RESOLVE_STOREFRONT_TOKEN = `#graphql
  mutation ResolveAttuneStorefrontToken($title: String!) {
...
export const RESOLVE_SHOP_BRAND = `#graphql
  query ResolveAttuneShopBrand {
